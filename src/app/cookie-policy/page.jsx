...
export const metadata = {
    title: "Cookie Policy",
    description:
        "Learn about the cookies KhelPediA uses, including analytics, essential, and preference cookies, and how you can manage them.",
    alternates: {
...
const cookieTypes = [
    ...
    {
        name: "Advertising Cookies (Future / Conditional)",
        description:
            "Once advertising services (such as Google AdSense) are enabled on KhelPediA, third-party advertising cookies may be set to serve personalized advertisements based on your browsing history. You can opt out of personalized ads at any time through Google's Ad Settings.",
        examples: "Cookies set by googlesyndication.com, doubleclick.net (when active)",
        canDisable: true,
    },
];
        ...
        <div className="page-container" style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem 1.5rem" }}>
            ...
            <section style={sectionStyle}>
                <p style={paragraphStyle}>
                    ...
                    browsing experience, analyze site traffic, and support website operations. This Cookie Policy explains what cookies are, how we use
            ...
            <section style={sectionStyle}>
                ...
                >
                    ...
                    >
                        Google Ad Personalization (When Advertising is Active)
                    </h3>
                    <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", lineHeight: 1.7 }}>
            ...
            <section style={sectionStyle}>
                ...
                <ul style={{ color: "var(--text-muted)", paddingLeft: "1.5rem", marginBottom: "1rem", lineHeight: 2 }}>
                    ...
                    <li><strong style={{ color: "var(--text-secondary)" }}>Google AdSense</strong> — for displaying advertisements (when advertising is active)</li>
                    <li><strong style={{ color: "var(--text-secondary)" }}>Supabase</strong> — for user authentication and session management</li>
                    <li><strong style={{ color: "var(--text-secondary)" }}>Vercel</strong> — for hosting and performance optimization</li>
                </ul>
                <p style={paragraphStyle}>
