...
export const metadata = {
    ...
    openGraph: {
        ...
        description:
            "Understand how KhelPediA handles your personal data, including Riot Games API data, analytics, and privacy protections.",
    },
};
        ...
        <div className="page-container" style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem 1.5rem" }}>
            ...
            >
                ...
                >
                    ...
                    <li>Google AdSense & Future Advertising</li>
            ...
            <section style={sectionStyle}>
                ...
                >
                    ...
                    <li>Display relevant advertisements through advertising partners (such as Google AdSense) if/when advertising services are active</li>
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    ...
                    essential cookies (theme preferences, authentication) and analytics
                    cookies (Google Analytics). Once advertising services are enabled, third-party advertising cookies may also be used.
                </p>
                <p style={paragraphStyle}>
            ...
            {/* 7. AdSense */}
            <section style={sectionStyle}>
                <h2 style={headingStyle}>7. Google AdSense & Future Advertising</h2>
                <p style={paragraphStyle}>
                    KhelPediA may display advertisements through Google AdSense or other third-party advertising partners once advertising features are enabled. When active, advertising networks may use cookies and web beacons to serve ads based on your visit to KhelPediA and other websites on the internet.
                </p>
                <p style={paragraphStyle}>
